...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "use_telegram_nick":
        ...
        log = (
            ...
            f"🔥 <i>{'Добивание' if bot_dobivanie else 'Защита от атаки'}:</i> {'✅' if bot_dobivanie or bot_attack_defense else '❌'} <b>(+{2 if bot_dobivanie else 1 if bot_attack_defense else 0})</b>\n\n"
            f"--------\n\n"
            f"<u>Тори</u> <b>Бот</b>:\n"
