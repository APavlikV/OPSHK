...
DEFENSE_PHRASES = {
    "defense_success": {
        "ГДН": ["<b>Вы</b> не растерялись, закрывая область ниже пояса среагировали верно 🛡️", "<b>Вы</b> стремительно защитили низ 🛡️", "<b>Вы</b> точно перекрыли пояс 🛡️", "<b>Вы</b> уверенно встали в защиту ног 🛡️", "<b>Вы</b> быстро закрыли нижнюю часть 🛡️"],
        "СС": ["<b>Вы</b> не растерялись, закрывая солнечное сплетение среагировали верно 🛡️", "<b>Вы</b> быстро прикрыли центр 🛡️", "<b>Вы</b> точно защитили живот 🛡️", "<b>Вы</b> уверенно перекрыли грудь 🛡️", "<b>Вы</b> стремительно закрыли середину 🛡️"],
        "ТР": ["<b>Вы</b> не растерялись, закрывая трахею среагировали верно 🛡️", "<b>Вы</b> быстро прикрыли шею 🛡️", "<b>Вы</b> точно защитили горло 🛡️", "<b>Вы</b> уверенно перекрыли трахею 🛡️", "<b>Вы</b> стремительно закрыли гортань 🛡️"],
        "ДЗ": ["<b>Вы</b> не растерялись, закрывая голову среагировали верно 🛡️", "<b>Вы</b> быстро прикрыли лицо 🛡️", "<b>Вы</b> точно защитили голову 🛡️", "<b>Вы</b> уверенно перекрыли череп 🛡️", "<b>Вы</b> стремительно закрыли висок 🛡️"]
    },
    "defense_fail": {
        "ГДН": ["<b>Вы</b> замешкались, закрывая область ниже пояса пропустили контроль", "<b>Вы</b> неловко прикрыли низ и промахнулись", "<b>Вы</b> медленно среагировали на пояс", "<b>Вы</b> неуверенно защитили ноги", "<b>Вы</b> сбились, пропустив низ"],
        "СС": ["<b>Вы</b> замешкались, закрывая солнечное сплетение пропустили контроль", "<b>Вы</b> неловко прикрыли центр и промахнулись", "<b>Вы</b> медленно среагировали на живот", "<b>Вы</b> неуверенно защитили грудь", "<b>Вы</b> сбились, пропустив середину"],
        "ТР": ["<b>Вы</b> замешкались, закрывая трахею пропустили контроль", "<b>Вы</b> неловко прикрыли шею и промахнулись", "<b>Вы</b> медленно среагировали на горло", "<b>Вы</b> неуверенно защитили трахею", "<b>Вы</b> сбились, пропустив шею"],
        "ДЗ": ["<b>Вы</b> замешкались, закрывая голову пропустили контроль", "<b>Вы</b> неловко прикрыли лицо и промахнулись", "<b>Вы</b> медленно среагировали на голову", "<b>Вы</b> неуверенно защитили череп", "<b>Вы</b> сбились, пропустив висок"]
    },
    "counter_success": {
    ...
    if query.data == "rules":
        ...
        if sequence and step is not None:
            ...
            short_log = f"Атака {step + 1}\nКонтроль: {control}\nАтака: {attack}\nЗащита и контратака: {chosen_defense}\n" \
                        f"<b>{'УСПЕХ' if is_success else 'ПОРАЖЕНИЕ'}</b>" + (f" (правильно: {correct_answer})" if not is_success and correct_answer else "")
