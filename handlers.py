...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "rules":
        ...
        await query.edit_message_text(
            ...
            "<b>Во первых</b>: Все технические элементы (аге, сото, учи и гедан) можно условно разделить на 3 части.\n"
            ...
            "<b>2)</b> Контр атака тут может быть как в грудь, так и в голову (в зависимости от ситуации, соответственно ДЗ или ТР)\n"
            "<b>3)</b> Последний элемент Аге уке это добивание в голову или защита головы (ТР или ДЗ)\n\n"
            "Другие варианты контр атак так же много вариантные и нужно, вернее, полезно понимание того, что последний элемент Аге уке не обязательно в ДЗ - возможен и уровень ТР\n\n"
            "Это тренажер на воображение и открытие для себя понимания, что изучаемая техника далеко не однозначна и может использоваться вариабельно в зависимости от реальной ситуации.\n\n"
            "Что бы правильно ответить необходимо представить весь процесс боевых действий и в своей голове воспроизвести каждый этап.\n\n"
            "<b>Во вторых</b>: как уже понятно, в представленном выше описании нет третьей части этих техник, поэтому может вызвать некоторое недопонимание.\n"
            "<b>Еще раз</b> ☝🏻 каждое техническое действие (аге, сото, учи и гедан) сотоит из 3 частей:\n"
            "<b>1)</b> защита от контроля\n"
            "<b>2)</b> контр атака\n"
            "<b>3)</b> завершающий элемент (это может быть как добивание так и вынужденная защита от атаки после контроля)\n\n",
            parse_mode="HTML"
