...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "rules":
        ...
        await query.edit_message_text(
            ...
            "<u>Блоки:</u>\n"
            "------------------------------------\n"
            "|     Действие    | Защита | Контатака | Добивание/Защита |\n"
            "------------------------------------\n"
            "- <b>Аге уке</b>:     СС    →   ДЗ/ТР    →   ДЗ\n"
            "- <b>Учи уке</b>:     СС    →   ДЗ/ТР    →   ДЗ/ТР/СС\n"
            "- <b>Сото уке</b>:    ТР    →   ДЗ/СС    →   ДЗ/ТР/СС\n"
            "- <b>Гедан барай</b>: ДЗ    →   ТР/СС    →   ТР/СС/ГДН",
            parse_mode="HTML"
        )
